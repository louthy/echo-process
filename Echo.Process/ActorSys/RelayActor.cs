...
namespace Echo
{
    ...
    public class RelayMsg
    {
        ...
        public RelayMsg(MsgTag tag, ClientConnectionId connectionId, ProcessId to, ProcessId sender, bool isAsk)
        {
            Tag = tag;
    ...
    public class InboundRelayMsg : RelayMsg
    {
        ...
        public InboundRelayMsg(ClientConnectionId connectionId, object msg, ProcessId to, ProcessId sender, bool isAsk)
            :
