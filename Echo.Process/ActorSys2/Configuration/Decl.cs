namespace Echo.ActorSys2.Configuration
{
    public abstract record Decl(Loc Location, string Name)
    {
        ...
        public static Decl Strategy(Loc Location, string Name, TmRecord Value) => new DeclStrategy(Location, Name, Value);
    ...
    public record DeclStrategy(Loc Location, string Name, TmRecord Value) : Decl(Location, Name);
