...
namespace Echo
{
    public static class Strategy
    {
        ...
        public static State<StrategyContext, Unit> Return(Func<StrategyContext, StrategyContext> f) =>
        ...
        public static State<StrategyContext, Unit> Compose(params State<StrategyContext, Unit>[] stages) =>
            Return(state => (stages.Fold(state, (s, c) => c.Run(s).State), unit));
        ...
        public static State<StrategyContext, Unit> OneForOne(params State<StrategyContext, Unit>[] stages) =>
            Return(state => Compose(stages).Run(state.With(Affects: new ProcessId[1] { state.Self })));
        ...
        public static State<StrategyContext, Unit> AllForOne(params State<StrategyContext, Unit>[] stages) =>
            Return(state => Compose(stages).Run(state.With(Affects: state.Siblings)));
        ...
        /// want a no-op
        /// </summary>
        public static State<StrategyContext, Unit> Identity =>
